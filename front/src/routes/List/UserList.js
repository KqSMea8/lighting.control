  ...
  render() {
    ...
    const userHeader = (
      <Row>
        ...
        <Col
          span={6}
          onClick={e => this.handleModalVisible(e, true)}
          style={{ cursor: "pointer" }}
        >
          <Icon type="plus" />
          新建
      ...
      <PageHeaderLayout title="用户权限管理">
        <div style={{ overflow: "scroll" }}>
          <Row gutter={16} style={{ minWidth: "600px" }}>
              ...
              <List
                ...
                renderItem={item => (
                  <List.Item
                    ...
                    style={
                      this.state.selectUser === item.userId
                        ? checkedBg
                        : { cursor: "pointer" }
                    }
                  >
            ...
            <Col span={12}>
              <Table rowKey="projectId" bordered dataSource={list}>
                ...
                <Column
                  ...
                  render={(text, record) => {
                    return (
                      <Checkbox
                        onChange={e =>
                          this.changeManage(e, 1, record.projectId)
                        }
                        checked={text === 1}
                      />
                    );
                ...
                <Column
                  ...
                  render={(text, record) => {
                    return (
                      <Checkbox
                        onChange={e =>
                          this.changeManage(e, 2, record.projectId)
                        }
                        checked={text === 1}
                      />
                    );
