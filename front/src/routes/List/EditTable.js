    ...
    form.validateFields((err, fieldsValue) => {
      ...
      if (itemType === "device") {
        ...
        if (source.itemType === 1) {
          ...
          sumitData.sourceId = source.deviceIdOrGroupId;
        }
  ...
  return (
    <div>
      <Modal
        ...
        footer={footerButton()}
      >
        <FormItem {...formItemLayout} label="Caption">
        ...
        <FormItem {...formItemLayout} label="Source">
          {getFieldDecorator("source", {
            rules: [{ required: true, message: "请选择" }],
            initialValue:
              editData.sourceName || editData.name || source.deviceOrGroupName
          })(<Input placeholder="请选择" onClick={goselectSource} />)}
        </FormItem>
        <FormItem {...formItemLayout} label="Variable">
          {getFieldDecorator("variable", {
            ...
            <Input
              placeholder="请选择"
              onClick={goselectVariable}
              disabled={source.itemType !== 1}
            />
          )}
        </FormItem>
        <FormItem {...formItemLayout} label="类别">
          {getFieldDecorator("valueType", {
            ...
            >
              ...
              <Option value="AI" disabled={itemType === "dust"}>
                AI
              </Option>
              <Option value="AV" disabled={itemType === "dust"}>
                AV
              </Option>
            </Select>
          )}
        ...
        <FormItem {...formItemLayout} label="Factor">
...
export default class EditTable extends PureComponent {
  ...
  render() {
    ...
    const { modalVisible, canSelt, source, variable } = this.state;
        ...
        <div style={{ padding: "0 14px" }}>
          <Row style={{ padding: "10px" }}>
            ...
            <Col span={8} style={{ textAlign: "right" }}>
              ...
              />
              <Button icon="plus" onClick={e => addData(e)}>
                添加数据
              </Button>
            </Col>
          </Row>
