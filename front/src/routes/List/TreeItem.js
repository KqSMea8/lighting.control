        ...
        const editNode =
          type === "dust" ? (
            <div className={treeStyle.edit}>
              ...
              <Icon
                type="delete"
                onClick={e => this.deleteItem(e, item, type)}
              />
            </div>
          ) : (
            <div />
          );
        return searchLen > 0 && index < 0 ? null : (
          <Card
            key={item.panelId}
    ...
    return (
      <div>
        ...
        <div>
          ...
          >
            <Icon
              type={dustExpand ? "minus" : "plus"}
              style={{ paddingRight: "8px" }}
            />
            自定义控制界面
            <Icon
              type="file-add"
              className={treeStyle.titleEdit}
              onClick={e => this.chnageItem(e, {}, "dust")}
            />
          </div>
          <div
            style={{
