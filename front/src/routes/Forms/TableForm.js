          ...
          if (record.editable) {
            return (
              <Input
                value={text}
                onChange={e =>
                  this.handleFieldChange(e, "deviceName", record.id)
                }
                autoFocus
          ...
          if (record.editable) {
            return (
              <Input
                value={text}
                onChange={e =>
                  this.handleFieldChange(e, "deviceCode", record.id)
                }
          ...
          if (record.editable) {
            return (
              <Input
                value={text}
                onChange={e =>
                  this.handleFieldChange(e, "beatContent", record.id)
                }
                // onBlur={e => this.saveRow(e, record.key)}
                // onKeyPress={e => this.handleKeyPress(e, record.key)}
                placeholder="心跳包内容"
        ...
        render: (text, record) => {
          ...
          return (
            <span>
              ...
              <Divider type="vertical" />
              <Link
                to={`/dtu/${record.id}/${record.device}`}
                onClick={e => this.checkDevice(e, record.device)}
              >
                编辑DTU串口
              </Link>
            </span>
